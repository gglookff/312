...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Calibri", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(218, 91);
			...
			this->label1->Size = System::Drawing::Size(395, 19);
			this->label1->TabIndex = 2;
			this->label1->Text = L"Введите целое число (высота строки/ширина столбца)";
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(158, 48);
			...
			this->ClientSize = System::Drawing::Size(412, 136);
